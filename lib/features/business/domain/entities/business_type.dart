...
enum BusinessType {
  ...
  String label(AppLocalizations l10n) => switch (this) {
        ...
        BusinessType.convenienceStore => l10n.businessTypeConvenienceStore,
        BusinessType.bakery => l10n.businessTypeBakery,
        BusinessType.pastry => l10n.businessTypePastry,
        BusinessType.wholesale => l10n.businessTypeWholesale,
        BusinessType.restaurant => l10n.businessTypeRestaurant,
        BusinessType.pizzeria => l10n.businessTypePizzeria,
        BusinessType.cafe => l10n.businessTypeCafe,
        BusinessType.fastFood => l10n.businessTypeFastFood,
        BusinessType.bar => l10n.businessTypeBar,
        BusinessType.catering => l10n.businessTypeCatering,
        BusinessType.butcher => l10n.businessTypeButcher,
        BusinessType.iceCream => l10n.businessTypeIceCream,
        BusinessType.flowerShop => l10n.businessTypeFlowerShop,
        BusinessType.jewelry => l10n.businessTypeJewelry,
        BusinessType.bookstore => l10n.businessTypeBookstore,
        BusinessType.pharmacy => l10n.businessTypePharmacy,
        BusinessType.petShop => l10n.businessTypePetShop,
        BusinessType.veterinary => l10n.businessTypeVeterinary,
        ...
        BusinessType.dental => l10n.businessTypeDental,
